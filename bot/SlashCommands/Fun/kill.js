...
module.exports = {
  ...
  run: async (client, interaction, args) => {
    let target = interaction.options.getUser('enemy') || args.join(" ");
    let author = interaction.member;
    let isBotOwner = require("../../config.json").OWNER_ID;
    if (args.length == 0) {
      return interaction.reply("Damn, You are trying to kill the air..??").then((interaction) => setTimeout(() => interaction.deleteReply(), 2300));
    }
    var kills = [
