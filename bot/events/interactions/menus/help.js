...
module.exports = async(interaction, client) => {
    ...
    if (interaction.customId === "help_menu") {
      ...
      await msg.edit({ embeds: [settingsEmbed] });
        ...
        .setDescription(
          "`additem`, `balance`, banklb`, `clearallpurchase`, `clearshop`, `daily`, `deposit`, `inventory`, `leaderboard`, `purchase`, `removeitem`, `searchshop`, `shop`, `throwall`, `use`, `weekly`, `withdraw`, `work`"
        )
        .setColor("RANDOM");
        ...
        .setDescription(
          "`deletegw`, `edit`, end`, `pause`, `unpause`, `start`, `reroll`\n\n```Note: giveaway commands work only with slash commands!```"
        )
        .setColor("RANDOM");
